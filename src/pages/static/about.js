...
const About = () => {
    return (
        <Container>
            ...
            <h2>Vision</h2>
            <p>Créer une plateforme globale accessible à tous les types de consommateurs, éliminer les barrières et rendre le marché de l’automobile plus transparent et plus ouvert. </p>
